...
# ⚒️ Reporting Discipline

**Turn long evidence streams into concise, honest, verifiable reports.**

> 把长日志、测试、Agent 结果和调查证据压缩成诚实、可核验的报告。

<p>
  <a href="https://github.com/Fable-Forge/reporting-discipline/blob/main/LICENSE"><img alt="License: MIT" src="https://img.shields.io/badge/license-MIT-0969da"></a>
...
```text
Install reporting-discipline: https://raw.githubusercontent.com/Fable-Forge/reporting-discipline/main/docs/install.md
```

Or use the Agent Skills CLI:

```bash
npx skills add Fable-Forge/reporting-discipline
```
...
- Maturity: `beta`
- GitHub Topics: `reporting`, `verification`, `evidence`, `agent-workflow`
...
- 🐛 Bugs and feature requests: [reporting-discipline Issues](https://github.com/Fable-Forge/reporting-discipline/issues)
