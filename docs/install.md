...
```text
安装 reporting-discipline：https://raw.githubusercontent.com/Fable-Forge/reporting-discipline/main/docs/install.md
```
...
从 `https://github.com/Fable-Forge/reporting-discipline` 安装 `reporting-discipline`，验证目标目录和 `SKILL.md`，并诚实报告哪些 Agent 已可发现。
...
| 运行时 | 目标目录 |
|---|---|
| Codex | `~/.codex/skills/reporting-discipline/` |
| Claude Code | `~/.claude/skills/reporting-discipline/` |
| Agent Skills | `~/.agents/skills/reporting-discipline/` |
