...
```text
帮我安装 reporting-discipline：https://raw.githubusercontent.com/Fable-Forge/reporting-discipline/main/docs/install.md
```
...
- 🐛 Bug 与功能建议：[reporting-discipline Issues](https://github.com/Fable-Forge/reporting-discipline/issues)
